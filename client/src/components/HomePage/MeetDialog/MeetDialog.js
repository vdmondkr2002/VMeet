...
import {makeStyles,Button,Dialog,Typography,IconButton,withStyles} from '@material-ui/core'
        ...
        <div>
            <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
                ...
                <DialogContent dividers>
                    ...
                    <CopyToClipboard text={`http://localhost:3000/join/${code}`}>
                        <Button variant="contained"  fullWidth endIcon={<AssignmentOutlinedIcon fontSize="large" />}>
