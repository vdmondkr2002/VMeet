...
import { Container,Grid,makeStyles, Paper,Avatar,Box, Typography,Button } from '@material-ui/core'
    ...
    */
    ...
    const getUserMediaSuccess = (stream) => {
		...
		for (let id in connections) {
            ...
            window.localStream?.getTracks().forEach((track) =>{                //Add Audio and videoTracks to all the connections
    ...
    const gotMessageFromServer = (fromId, message) => {
        ...
        if (fromId !== socketId) {    //Doubt about this check 
        ...
        <Container className={clsx(classes.content,{
            [classes.contentShift]: peopleOpen,
                    ...
                    {/* <Paper className={classes.userPaper}> */}
                        ...
                        ,
                    {/* </Paper> */}
                    <video playsInline style={{width:"100px",height:"200px"}} muted ref={myStream} autoPlay />
                <div  id="main">
